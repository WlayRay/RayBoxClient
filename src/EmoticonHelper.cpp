...
QString Emoticon::file() const
{
    return m_file;
}

void Emoticon::setFile(const QString &newFile)
{
    if (m_file == newFile)
        return;
    m_file = newFile;
...
void Emoticon::setName(const QString &newName)
{
    if (m_name == newName)
        return;
    m_name = newName;
...
QString Emoticon::tag() const
{
    return m_tag;
}

void Emoticon::setTag(const QString &newTag)
{
    if (m_tag == newTag)
        return;
    m_tag = newTag;
